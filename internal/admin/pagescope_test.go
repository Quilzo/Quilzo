...
func scoped(t *testing.T, bindings ...auth.Binding) (*Server, map[string]string) {
	...
	// Notes and Checked are on main and not here: both arrived after v0.2.1,
	// with their own handlers. The scope rule this test is about is the same
	// for the handlers that do exist, and those are what it exercises.
